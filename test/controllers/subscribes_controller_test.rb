...
class SubscribesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscribe" do
    assert_difference('Subscribe.count') do
      post subscribes_url, params: { subscribe: { is_mail: @subscribe.is_mail, is_message: @subscribe.is_message, topic_id: @subscribe.topic_id, user_id: @subscribe.user_id } }
    end
  ...
  test "should update subscribe" do
    patch subscribe_url(@subscribe), params: { subscribe: { is_mail: @subscribe.is_mail, is_message: @subscribe.is_message, topic_id: @subscribe.topic_id, user_id: @subscribe.user_id } }
